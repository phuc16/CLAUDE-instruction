...
Then suggest a commit message based on what was just completed:
```
...
**Step 4 — Suggest a commit message** based on all completed items this session:
```
git commit -m "<verb>: <summary of what was done>"
```
